                        ...
                        <?php
                            if(isset($_POST["submit"])) {
                                ...
                                if(mysqli_num_rows($isExists) > 0) {
                                    ...
                                    $mysql = new mysqli("localhost", "root","","urlshortener");
                                    $request = mysqli_query($mysql, "insert into users (username, password, email) values  ('" . $_POST["username"] . "','" . $_POST["password"] . "','" . $_POST["email"] . "')");
                                    session_start();
                        ...
                        <div class="mt-4">
                            <div class=" h-full w-full">
                                <form method="POST">
                                   ...
                                   <div class="mx-2 my-3">
                                        <input name="email" type="email" placeholder="Email" required class="w-full text-lg outline-none rounded-xl p-2" />
                                    </div>
                                    <div class="mx-2 my-3">
                                    ...
                                    <div class="mx-4 flex justify-center p-2 rounded-xl" style="background-color: #04c484">
                                        <button type="submit" name="submit" class="text-white font-bold text-lg w-full" value="1">Register</button>
                                    </div>
                                </form>
                        </div>
                </div>
